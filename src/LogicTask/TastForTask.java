...
public class TastForTask {
    ...
    public int[][] arr = {{1,2,3,4,5,6,7},{5,3,2,1,4,5,6},{1,1,1,1,1,1,1},{3,1,2,3,5,6,3},{4,2,3,4,5,1,7}};
    public int[][] arr1 = {{9,5,3,-7,-9},{7,1,-5,-11,-17},{-1,-3,-13,-15,-19}};
    public int[][] arr2 = {{1,2,3},{5,3,2},{1,1,1},{3,1,2},{4,2,3}};
    public int[][] arr3 = {{1},{2},{3},{4},{5}};
    public int[][] arr4 = {{1,2,3,4,5,6,7}};
    public int[][] arr5 = {{1},{2}};
}
